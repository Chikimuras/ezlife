...
class GlobalConstraints(Base):
    ...
    total_weekly_hours: Mapped[float] = mapped_column(Float, default=168.0)
    min_sleep_hours: Mapped[float] = mapped_column(Float, default=56.0)

    underutilization_threshold: Mapped[float] = mapped_column(Float, default=0.8)
    overutilization_threshold: Mapped[float] = mapped_column(Float, default=1.2)
    wasted_time_threshold: Mapped[float] = mapped_column(Float, default=2.0)
