...
*   **Type Check**: `npx vue-tsc --noEmit`
    *   *Rule*: ALWAYS run this after making changes to `.ts` or `.vue` files to ensure type safety.
*   **Linting**: Currently relies on strict TypeScript settings in `tsconfig.app.json`.
